# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject Gtk.Popover()."""
import gi
...
class HamburgerMenu(Gtk.Popover):
    def __init__(self, **kwargs):
        ...
        button_select_all.add_css_class(css_class='flat')
...
class ExampleWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject Gtk.Popover()')
