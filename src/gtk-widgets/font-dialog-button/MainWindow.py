# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject Gtk.FontDialogButton()."""
...
class ExampleWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject Gtk.FontDialogButton()')
        ...
        label = Gtk.Label.new(str='Clique no botão para selecionar uma fonte.')
        vbox.append(child=label)

        font_dialog = Gtk.FontDialog.new()
        font_dialog.set_modal(modal=True)
        font_dialog.set_title(title='Selecione uma fonte.')
    ...
    def on_font_selected(self, font_dialog_button, g_param_boxed):
        ...
        print(f'Nome da fonte: {pango_font_description.get_family()}')
        print(f'Tamanho da fonte: {pango_font_description.get_size()}')
        print(f'Estilo da fonte: {pango_font_description.get_style()}')
        print(f'Peso da fonte: {pango_font_description.get_weight()}')
