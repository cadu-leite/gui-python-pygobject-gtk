...
class ExampleWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject Gtk.ColorDialogButton()')
        ...
        label = Gtk.Label.new(str='Clique no botão para selecionar uma cor.')
    ...
    def on_color_selected(self, color_dialog_button, g_param_boxed):
        ...
        print(f'Cor RGB = {gdk_rgba.to_string()}')
