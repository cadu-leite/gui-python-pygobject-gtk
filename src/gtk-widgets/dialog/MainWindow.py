# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject Gtk.Dialog() personalizado."""
...
class CustomDialog(Gtk.Dialog):
    ...
    def __init__(self, **kwargs):
        ...
        btn_ok.add_css_class(css_class='suggested-action')
...
class ExampleWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject Gtk.Dialog() personalizado')
