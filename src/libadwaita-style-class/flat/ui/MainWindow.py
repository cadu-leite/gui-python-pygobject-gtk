# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class flat ui file."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    button_flat = Gtk.Template.Child(name='button_flat')
    ...
    def on_button_clicked(self, button):
        ...
        self.button_flat.set_label(
            label=f'Botão - classes: {self.button_flat.get_css_classes()}',
        )
