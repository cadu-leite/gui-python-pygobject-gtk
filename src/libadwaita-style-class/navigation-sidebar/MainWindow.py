# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class navigation-sidebar."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject style classe navigation-sidebar')
        ...
        self.label = Gtk.Label.new(str="Classes: ['navigation-sidebar']")
        ...
        for n in range(1, 4):
            ...
            label = Gtk.Label.new(str=f'ListBox - {n}')
    ...
    def on_button_clicked(self, button):
        if 'navigation-sidebar' in self.list_box.get_css_classes():
            ...
            self.list_box.add_css_class(css_class='navigation-sidebar')
        self.label.set_text(
            str=f'Classes: {self.list_box.get_css_classes()}',
        )
