# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class circular."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject style classe circular')
    ...
    def on_button_clicked(self, button):
        if 'circular' in self.button_circular.get_css_classes():
            ...
            self.button_circular.add_css_class(css_class='circular')
        self.button_circular.set_label(
            label=f'Classes: {self.button_circular.get_css_classes()}',
        )
