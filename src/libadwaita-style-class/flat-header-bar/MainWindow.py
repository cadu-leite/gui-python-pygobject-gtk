# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class flat HeaderBar."""
...
class ExampleWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(
            title='Python e GTK: PyGObject libadwaita style class flat HeaderBar',
        )
        ...
        self.label = Gtk.Label.new(
            str="HeaderBar - classes: ['titlebar','flat']",
        )
