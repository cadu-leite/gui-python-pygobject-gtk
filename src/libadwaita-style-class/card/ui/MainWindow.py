# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class card ui file."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    label_card = Gtk.Template.Child(name='label_card')
    ...
    def on_button_clicked(self, button):
        ...
        self.label_card.set_text(
            str=LOREM.format(f'Classes: {self.label_card.get_css_classes()}'),
        )
