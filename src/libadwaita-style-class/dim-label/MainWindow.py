# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class dim-label."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject style classe dim-label')
        ...
        vbox.append(child=self.label_dim_label)
    ...
    def on_button_clicked(self, button):
        if 'dim-label' in self.label_dim_label.get_css_classes():
            self.label_dim_label.remove_css_class(css_class='dim-label')
        else:
            self.label_dim_label.add_css_class(css_class='dim-label')
