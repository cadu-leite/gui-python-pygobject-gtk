# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class boxed-list ui file."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    listbox = Gtk.Template.Child(name='listbox')
    adw_action_row_03 = Gtk.Template.Child(name='adw_action_row_03')
