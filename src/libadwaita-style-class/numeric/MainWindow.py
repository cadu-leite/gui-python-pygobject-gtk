# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class numeric."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject style classe numeric')
        ...
        self.label = Gtk.Label.new(str=TEXT.format("Classes: ['numeric']"))
    ...
    def on_button_clicked(self, button):
        if 'numeric' in self.label.get_css_classes():
            ...
            self.label.add_css_class(css_class='numeric')
        self.label.set_text(
            str=TEXT.format(f'Classes: {self.label.get_css_classes()}'),
        )
