...
class ExampleWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        label = Gtk.Label.new(
            str='A classe de estilo .background pode ser usada com qualquer '
            'widget para fornecer as cores padrão de fundo e primeiro plano '
            'da janela.\n\nIsso pode ser útil quando um widget precisa de um '
            'plano de fundo opaco - por exemplo, um flap filho dentro de um '
            'AdwFlap.'
        )
