# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class caption."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject style classe caption')
        ...
        label = Gtk.Label.new(
            str='A classe de estilo caption tornam o texto menor. Ele deve '
            'ser usado para diferenciar o subtexto que acompanha o texto no '
            'estilo regular body.',
        )
        ...
        vbox.append(child=self.label_caption)
