# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class osd."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject style classe osd')
        ...
        self.button_osd = Gtk.Button.new_with_label(
            label="Classes: ['text-button','osd']",
        )
        self.button_osd.add_css_class(css_class='osd')
        vbox.append(child=self.button_osd)
