# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita style class monospace."""
...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.set_title(title='Python e GTK: PyGObject style classe monospace')
        ...
        self.label = Gtk.Label.new(str=LOREM.format("Classes: ['monospace']"))
    ...
    def on_button_clicked(self, button):
        if 'monospace' in self.label.get_css_classes():
            ...
            self.label.add_css_class(css_class='monospace')
        self.label.set_text(
            str=LOREM.format(f'Classes: {self.label.get_css_classes()}'),
        )
