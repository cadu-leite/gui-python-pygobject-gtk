# -*- coding: utf-8 -*-
"""Python e GTK: PyGObject libadwaita Adw.Leaflet() ui file."""
...
class ExampleWindow(Adw.ApplicationWindow):
    '''É obrigatório utilizar a classe `Adw.ApplicationWindow`, caso
    contrário serão exibidas 2 barras de título.
    '''
